...
<html>
  <head>
    <meta http-equiv=\"refresh\" content=\"5; url='https://www.ijsselstreeklearning.nl/moodle'\" />
  </head>
  <body>
    <p>Moodle leeromgeving ijsselstreeklearning.nl redirect.<p>
    <p><a href=\"https://www.ijsselstreeklearning.nl/moodle\">Klik hier als de website niet doorgaat.</a></p>
  </body>
